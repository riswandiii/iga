                    ...
                    <div class="card-header pb-0">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-3 text-end mt-1">
                                <a href="{{ route('dashboard.banner.create') }}" class="btn btn-primary btn-sm d-inline">Tambah
                                    {{ $page }}</a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm"><a href="{{ asset('storage/' . $row->banner) }}" target="_blank"><img src="{{ asset('storage/' . $row->banner) }}" width="100" alt=""></a></h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    <a href="{{ route('dashboard.banner.edit', $row->id) }}"
                                                    ...
                                                    <a href="#" onclick="deleteBanner('{{ route('dashboard.banner.destroy', $row->id) }}')"><span
                                                        class="badge badge-sm bg-gradient-warning"><i

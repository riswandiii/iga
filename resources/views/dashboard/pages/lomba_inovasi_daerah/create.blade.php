        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-3">
                    <div class="card-body">
                        {{-- Form --}}
                        <form action="{{ route('dashboard.inovasi.daerah.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label">Inisiator Inovasi Daerah</label>
                                <div class="row gx-2">
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label">Bentuk Inovasi Daerah</label>
                            ...
                            <div class="mb-3">
                                <label for="datepicker" class="form-label">Waktu uji coba inovasi daerah</label>
                                <input id="datepicker" type="date" name="waktu_uji_coba" value="{{ old('waktu_uji_coba') }}" class="form-control @error('waktu_uji_coba') is-invalid @enderror datepicker">
                            ...
                            <div class="mb-3">
                                <label for="datepicker" class="form-label">Waktu penerapan inovasi daerah</label>
                                <input id="datepicker" type="date" name="waktu_penerapan" value="{{ old('waktu_penerapan') }}" class="form-control @error('waktu_penerapan') is-invalid @enderror datepicker">
                            ...
                            <div class="mb-3">
                                ...
                                <trix-editor input="rancang_bangun">{{ strip_tags(old('rancang_bangun')) }}
                                </trix-editor>
                            ...
                            <div class="mb-3">
                                ...
                                <trix-editor input="tujuan_inovasi">{{ strip_tags(old('tujuan_inovasi')) }}
                                </trix-editor>
                            ...
                            <div class="mb-3">
                                ...
                                <trix-editor input="manfaat_diperoleh">{{ strip_tags(old('manfaat_diperoleh')) }}
                                </trix-editor>
                            ...
                            <div class="mb-3">
                                ...
                                <trix-editor input="hasil_inovasi">{{ strip_tags(old('hasil_inovasi')) }}
                                </trix-editor>
                                @error('hasil_inovasi')
                                <div class="invalid-feedbac text-danger">
                                    {{ $message }}
                            ...
                            <div class="mt-5 mb-3">
                                <a href="{{ route('dashboard.inovasi.daerah') }}" class="btn btn-danger btn-sm">Batal</a>

...
@section('content')
                                                    ...
                                                    <div class="d-flex px-3 py-1">
                                                        <div class="">
                                                            ...
                                                            <div class="mt-1 text-center">
                                                                <form action="{{ route('dashboard.dokumen.pendukung') }}" method="POST" class="text-decoration-none text-dark mt-2" title="Upload dokumen pendukung">
                                                                    @csrf
                                                                    @method('get')
    ...
    {{-- Modal --}}
    @include('dashboard.component.modal_indikator')

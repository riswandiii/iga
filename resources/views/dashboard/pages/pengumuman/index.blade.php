                    ...
                    <div class="card-header pb-0">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-3 text-end mt-1">
                                <a href="{{ route('dashboard.pengumuman.create') }}" class="btn btn-primary btn-sm d-inline">Tambah
                                    {{ $page }}</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        @foreach ($datas as $row)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <a href="{{ route('dashboard.pengumuman.edit', $row->id) }}"
                                                    ...
                                                    <a href="#" onclick="deletePengumuman('{{ route('dashboard.pengumuman.destroy', $row->id) }}')"><span
                                                        class="badge badge-sm bg-gradient-warning"><i

                    ...
                    <div class="card-header pb-0">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-3 text-end mt-1">
                                <a href="{{ route('dashboard.account.create') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex px-3 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <?php 
                                                                $opd = \App\Models\Opd::where('id',$row->opd_id)->first();
                                                            ?>
                                                            @if($row->role === 'Opd')
                                                            ...
                                                            @else
                                                                <h6 class="mb-0 text-sm">{{ $row->nama_inisiator }}</h6>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <a href="{{ route('dashboard.account.edit', $row->id) }}"
                                                        class="badge bg-primary"><i class="bi bi-pencil-fill"></i></a>
                                                    {{-- <form action="{{ route('dashboard.account.destroy', $row->id) }}"
                                                    ...
                                                    <a href="#" onclick="deleteAccount('{{ route('dashboard.account.destroy', $row->id) }}')"><span
                                                        class="badge badge-sm bg-gradient-warning"><i

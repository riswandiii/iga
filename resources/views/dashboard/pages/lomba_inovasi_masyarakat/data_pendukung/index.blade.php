...
@section('content')
                                        ...
                                        <td>
                                            <div class="d-flex px-3 py-1">
                                                <div class="">
                                                    ...
                                                    @endif
                                                    {{-- <form action="{{ route('dashboard.dokumen.pendukung.destroyy', $row->id) }}" method="post" class="d-inline">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit" class="btn btn-warning btn-sm" onclick="return confirm('Yakin ingin hapus data?')">Hapus</button>
                                                    </form> --}}
                                                    <a href="#" onclick="deleteDataPendukungInovasiMasyarakat('{{ route('dashboard.dokumen.pendukung.destroyy', $row->id) }}')" class="btn btn-danger btn-sm">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
    ...
    @include('dashboard.component.modal_dokumen_pendukungg')
@endsection

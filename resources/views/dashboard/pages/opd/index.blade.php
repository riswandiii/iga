                    ...
                    <div class="card-header pb-0">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-3 text-end mt-1">
                                <a href="{{ route('dashboard.opd.create') }}" class="btn btn-primary btn-sm d-inline">Tambah
                                    {{ $page }}</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        @foreach ($datas as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex px-3 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">{{ $row->nama_opd }}</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    <a href="{{ route('dashboard.opd.edit', $row->id) }}"
                                                    ...
                                                    <a href="#" onclick="deleteOpd('{{ route('dashboard.opd.destroy', $row->id) }}')"><span
                                                        class="badge badge-sm bg-gradient-warning"><i
